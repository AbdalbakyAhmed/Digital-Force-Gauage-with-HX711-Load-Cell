      ...
      if (get_N >= 0) {
        ...
        while (ID_count == 12) {
          ...
          if (Key4 == '1') {
            ...
            //*********Print on Serial Monitor in Kilograms**********\\
            Serial.print("\n");
            Serial.print("Manufacturer : "); Serial.print("EGYEXPERTS.com"); Serial.print("\n");
            Serial.print("Customer : "); Serial.print("EAC"); Serial.print("\n");
            Serial.print("Batch ID : "); for (char p = 0; p <= (ID_count - 1); p++) {
              Serial.print(Batch_ID[p]);
            } Serial.print("\n");
            ...
            Serial.print("Num  "); Serial.print("Peak values in Kg  "); Serial.print("  Hr:Min:Sec"); Serial.print("\n");
            ...
            for (int y = 0; y < x; y++) {
              ...
              if (count < 10) {
                EEPROM.get(i, load);
                if ((load / gravity) < 10) {
                  Serial.print(count); Serial.print("         "); Serial.print((load / gravity), 5); Serial.print("         ");
                }
                ...
                //Serial.print(count); Serial.print("         "); EEPROM.get(i, load); Serial.print((load / gravity), 5); Serial.print("         ");
            ...
            Serial.print("Average: ");    Serial.println(stats.average(math_operationts, x), 5);
            Serial.print("MAX PEAK: ");    Serial.println(stats.maximum(math_operationts, x), 5);
            Serial.print("MIN PEAK: ");    Serial.println(stats.minimum(math_operationts, x), 5);
            Serial.print("Standard Deviation: ");    Serial.println(stats.stdev(math_operationts, x), 5);
            ...
            //*********Print on Serial Monitor in Newton**********\\
            Serial.print("\n");
            Serial.print("Manufacturer : "); Serial.print("EGYEXPERTS.com"); Serial.print("\n");
            Serial.print("Customer : "); Serial.print("EAC"); Serial.print("\n");
            Serial.print("Batch ID : "); for (char p = 0; p <= (ID_count - 1); p++) {
            ...
            Serial.print("Date : "); Serial.print(day()); Serial.print("/"); Serial.print(month()); Serial.print("/"); Serial.print(year()); Serial.print("\n");
            Serial.print("Num Of Samples : "); Serial.print(x); Serial.print("\n");
            Serial.print("Num  "); Serial.print("Peak values in N  "); Serial.print("  Hr:Min:Sec"); Serial.print("\n");
            int i = 0, count = 1; float load = 0;
            for (int y = 0; y < x; y++) {
              //check for adjusting the print out
              if (count < 10) {
                EEPROM.get(i, load );
                if (load < 10) {
                  Serial.print(count); Serial.print("         ");  Serial.print(load, 5); Serial.print("         ");
                }
